...
public class TaskAlarmReceiver extends  BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Intent starrtAppIntent = new Intent(context, MainActivity.class);
        starrtAppIntent.addFlags(Intent.FLAG_ACTIVITY_BROUGHT_TO_FRONT);
        PendingIntent pendingIntent = PendingIntent.getActivity(context, 0, starrtAppIntent, 0);
